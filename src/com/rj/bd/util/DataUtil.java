...
public class DataUtil {
	 ...
	 * @return
	 */
    public static String getUUIDWithoutSparator() {
	...
	public static String getHttpCNSafeString(String str){
		...
		//是不是以WIN开头
		boolean oscn1=os.startsWith("Win");
		boolean oscn2=os.startsWith("win");
		boolean oscn3=os.startsWith("Lin");
		boolean oscn4=os.startsWith("lin");
		boolean oscn5=os.startsWith("Mac");
		boolean oscn6=os.startsWith("mac");
		//若是Windows或Mac操作系统的，进行转码。若是Linux的，则维持原样返回。
		if(oscn1 || oscn2 || oscn3 || oscn4 || oscn5 || oscn6){
			try { strchanged=new String (str.getBytes("ISO-8859-1"),"utf-8"); } catch (Exception e) { LogUtil.exception(e); }
			return strchanged;
		} else {
			return str;
		}
