...
$.fn.ProvinceCity = function(){
	...
	//插入3个空的下拉框
	_self.append("<select id=\"province\"  name=\"memberbo.province\"></select>");
	_self.append("<select id=\"city1\" name=\" memberbo.city1\"></select>");
	_self.append("<select id=\"city2\" name=\" memberbo.city2\"></select>");
	//分别获取3个下拉框
